...
.. code-block:: console
    ...
    $ python -c 'import dffml; help(dffml.SLRModel)'
    Help on class SLRModel in module dffml.model.slr:

    class SLRModel(dffml.model.model.SimpleModel)
     |  SLRModel(config: 'BaseConfig') -> None
     |

...
class EventContext(abc.ABC, BaseDataFlowFacilitatorObjectContext):
...
@base_entry_point("dffml.df.event", "event")
class Event(BaseDataFlowFacilitatorObject):
    """
    Abstract base class which should be derived from
    and implemented various event data structures.
    """
